class Swctl < Formula
  ...
  url "https://github.com/nguyenytran/swctl/releases/download/v0.4.3/swctl-0.4.3.tar.gz"
  sha256 "b0202a2accb85eb1900013ca6e6d9d70e2af8585847f047f9a7d7df5f5035d3e"
  license "MIT"
  version "0.4.3"
